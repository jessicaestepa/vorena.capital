(function () {
  ...
  var translations = {
    en: {
      ...
      'manifesto.tagline': 'vorena. Where the next great explosion of value is hiding.',
      ...
      'companies.aitextspeak.name': 'AI TextSpeak',
      ...
      'companies.stealth.name': 'Stealth',
    ...
    es: {
      ...
      'manifesto.tagline': 'vorena. Donde se esconde la próxima gran explosión de valor.',
      'manifesto.signature': 'Jessica',
